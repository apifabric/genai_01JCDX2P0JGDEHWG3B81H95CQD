...
resourcename="dogwalkbiz"  # lower case, only
resourcegroup="dogwalkbiz_rg"
...
# git clone https://github.com/apilogicserver/dogwalkbiz.git
# cd dogwalkbiz
...
az group create --name dogwalkbiz_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogwalkbiz_rg --sku S1 --is-linux
az container create --resource-group dogwalkbiz_rg --name dogwalkbiz --image apilogicserver/dogwalkbiz:latest --dns-name-label dogwalkbiz --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogwalkbiz.westus.azurecontainer.io:5656'
