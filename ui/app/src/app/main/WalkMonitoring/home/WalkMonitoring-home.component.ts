...
@Component({
  selector: 'WalkMonitoring-home',
  templateUrl: './WalkMonitoring-home.component.html',
  styleUrls: ['./WalkMonitoring-home.component.scss']
})
export class WalkMonitoringHomeComponent implements AfterViewInit {
