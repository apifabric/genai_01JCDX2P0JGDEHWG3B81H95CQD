...
@Component({
  selector: 'WalkerRate-home',
  templateUrl: './WalkerRate-home.component.html',
  styleUrls: ['./WalkerRate-home.component.scss']
})
export class WalkerRateHomeComponent implements AfterViewInit {
