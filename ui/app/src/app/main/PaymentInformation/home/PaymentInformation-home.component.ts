...
@Component({
  selector: 'PaymentInformation-home',
  templateUrl: './PaymentInformation-home.component.html',
  styleUrls: ['./PaymentInformation-home.component.scss']
})
export class PaymentInformationHomeComponent implements AfterViewInit {
