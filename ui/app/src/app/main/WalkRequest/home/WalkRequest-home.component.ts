...
@Component({
  selector: 'WalkRequest-home',
  templateUrl: './WalkRequest-home.component.html',
  styleUrls: ['./WalkRequest-home.component.scss']
})
export class WalkRequestHomeComponent implements AfterViewInit {
