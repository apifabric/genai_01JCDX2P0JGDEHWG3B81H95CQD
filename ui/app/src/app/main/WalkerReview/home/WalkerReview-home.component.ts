...
@Component({
  selector: 'WalkerReview-home',
  templateUrl: './WalkerReview-home.component.html',
  styleUrls: ['./WalkerReview-home.component.scss']
})
export class WalkerReviewHomeComponent implements AfterViewInit {
