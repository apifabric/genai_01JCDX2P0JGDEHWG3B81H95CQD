...
@Component({
  selector: 'Walker-home',
  templateUrl: './Walker-home.component.html',
  styleUrls: ['./Walker-home.component.scss']
})
export class WalkerHomeComponent implements AfterViewInit {
