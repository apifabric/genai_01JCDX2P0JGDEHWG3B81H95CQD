...
@Component({
  selector: 'WalkerAvailability-home',
  templateUrl: './WalkerAvailability-home.component.html',
  styleUrls: ['./WalkerAvailability-home.component.scss']
})
export class WalkerAvailabilityHomeComponent implements AfterViewInit {
