...
@Component({
  selector: 'WalkSchedule-home',
  templateUrl: './WalkSchedule-home.component.html',
  styleUrls: ['./WalkSchedule-home.component.scss']
})
export class WalkScheduleHomeComponent implements AfterViewInit {
