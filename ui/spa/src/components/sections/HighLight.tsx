...
const ResourceTable = () => {
  ...
  return (
    <div style={{ padding: '16px' }}>
      <Typography variant="h4" gutterBottom style={{ color: 'purple', border: '2px solid purple', padding: '8px' }}>Car Dealership</Typography>
      ...
      <Dialog open={!!dialogData} onClose={handleCloseDialog} fullWidth maxWidth="md">
        ...
        <DialogContent>
          {dialogData && (
            <div>
              <Typography variant="h5" gutterBottom style={{ color: 'purple' }}>{dialogData.resourceType}</Typography>
              <List>
